...
@Entity
@Table(name = "transacoes_str", schema = "aurix")
public class TransacaoSTR {
    @Id
    ...
    @Column(nullable = false)
    private TipoSTR tipoSTR;
    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    private StatusSTR status = StatusSTR.PENDENTE;
    @Column
    ...
    public enum StatusSTR {
        PENDENTE, AGENDADA, ENVIANDO, LIQUIDADA, REJEITADA, CANCELADA, ERRO;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setTipoSTR(final TipoSTR tipoSTR) {
        this.tipoSTR = tipoSTR;
    }

    @java.lang.SuppressWarnings("all")
    public void setStatus(final StatusSTR status) {
        this.status = status;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof TransacaoSTR)) return false;
        final TransacaoSTR other = (TransacaoSTR) o;
        ...
        final java.lang.Object this$tipoSTR = this.getTipoSTR();
        final java.lang.Object other$tipoSTR = other.getTipoSTR();
        if (this$tipoSTR == null ? other$tipoSTR != null : !this$tipoSTR.equals(other$tipoSTR)) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof TransacaoSTR;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $tipoSTR = this.getTipoSTR();
        result = result * PRIME + ($tipoSTR == null ? 43 : $tipoSTR.hashCode());
    ...
    public java.lang.String toString() {
        return "TransacaoSTR(id=" + this.getId() + ", numeroControle=" + this.getNumeroControle() + ", ispbOrigem=" + this.getIspbOrigem() + ", ispbDestino=" + this.getIspbDestino() + ", contaOrigem=" + this.getContaOrigem() + ", contaDestino=" + this.getContaDestino() + ", valor=" + this.getValor() + ", tipoSTR=" + this.getTipoSTR() + ", status=" + this.getStatus() + ", dataCriacao=" + this.getDataCriacao() + ", dataAgendamento=" + this.getDataAgendamento() + ", dataEnvio=" + this.getDataEnvio() + ", dataLiquidacao=" + this.getDataLiquidacao() + ", codigoRetorno=" + this.getCodigoRetorno() + ", mensagemRetorno=" + this.getMensagemRetorno() + ", dadosResposta=" + this.getDadosResposta() + ", tentativasEnvio=" + this.getTentativasEnvio() + ", maxTentativas=" + this.getMaxTentativas() + ", observacoes=" + this.getObservacoes() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
    public TransacaoSTR(final Long id, final String numeroControle, final String ispbOrigem, final String ispbDestino, final String contaOrigem, final String contaDestino, final BigDecimal valor, final TipoSTR tipoSTR, final StatusSTR status, final LocalDateTime dataCriacao, final LocalDateTime dataAgendamento, final LocalDateTime dataEnvio, final LocalDateTime dataLiquidacao, final String codigoRetorno, final String mensagemRetorno, final String dadosResposta, final Integer tentativasEnvio, final Integer maxTentativas, final String observacoes) {
        this.id = id;
        this.numeroControle = numeroControle;
        this.ispbOrigem = ispbOrigem;
        this.ispbDestino = ispbDestino;
