...
public class TransacaoDTO {
    ...
    public BigDecimal getSaldoAnteriorOrigem() {
        return this.saldoAnteriorOrigem;
    }

    @java.lang.SuppressWarnings("all")
    public BigDecimal getSaldoPosteriorOrigem() {
        return this.saldoPosteriorOrigem;
    }

    @java.lang.SuppressWarnings("all")
    public BigDecimal getSaldoAnteriorDestino() {
        return this.saldoAnteriorDestino;
    }

    @java.lang.SuppressWarnings("all")
    public BigDecimal getSaldoPosteriorDestino() {
        return this.saldoPosteriorDestino;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setSaldoAnteriorOrigem(final BigDecimal saldoAnteriorOrigem) {
        this.saldoAnteriorOrigem = saldoAnteriorOrigem;
    }

    @java.lang.SuppressWarnings("all")
    public void setSaldoPosteriorOrigem(final BigDecimal saldoPosteriorOrigem) {
        this.saldoPosteriorOrigem = saldoPosteriorOrigem;
    }

    @java.lang.SuppressWarnings("all")
    public void setSaldoAnteriorDestino(final BigDecimal saldoAnteriorDestino) {
        this.saldoAnteriorDestino = saldoAnteriorDestino;
    }

    @java.lang.SuppressWarnings("all")
    public void setSaldoPosteriorDestino(final BigDecimal saldoPosteriorDestino) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final java.lang.Object this$saldoAnteriorOrigem = this.getSaldoAnteriorOrigem();
        final java.lang.Object other$saldoAnteriorOrigem = other.getSaldoAnteriorOrigem();
        if (this$saldoAnteriorOrigem == null ? other$saldoAnteriorOrigem != null : !this$saldoAnteriorOrigem.equals(other$saldoAnteriorOrigem)) return false;
        final java.lang.Object this$saldoPosteriorOrigem = this.getSaldoPosteriorOrigem();
        final java.lang.Object other$saldoPosteriorOrigem = other.getSaldoPosteriorOrigem();
        if (this$saldoPosteriorOrigem == null ? other$saldoPosteriorOrigem != null : !this$saldoPosteriorOrigem.equals(other$saldoPosteriorOrigem)) return false;
        final java.lang.Object this$saldoAnteriorDestino = this.getSaldoAnteriorDestino();
        final java.lang.Object other$saldoAnteriorDestino = other.getSaldoAnteriorDestino();
        if (this$saldoAnteriorDestino == null ? other$saldoAnteriorDestino != null : !this$saldoAnteriorDestino.equals(other$saldoAnteriorDestino)) return false;
        final java.lang.Object this$saldoPosteriorDestino = this.getSaldoPosteriorDestino();
        final java.lang.Object other$saldoPosteriorDestino = other.getSaldoPosteriorDestino();
        if (this$saldoPosteriorDestino == null ? other$saldoPosteriorDestino != null : !this$saldoPosteriorDestino.equals(other$saldoPosteriorDestino)) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $saldoAnteriorOrigem = this.getSaldoAnteriorOrigem();
        result = result * PRIME + ($saldoAnteriorOrigem == null ? 43 : $saldoAnteriorOrigem.hashCode());
        final java.lang.Object $saldoPosteriorOrigem = this.getSaldoPosteriorOrigem();
        result = result * PRIME + ($saldoPosteriorOrigem == null ? 43 : $saldoPosteriorOrigem.hashCode());
        final java.lang.Object $saldoAnteriorDestino = this.getSaldoAnteriorDestino();
        result = result * PRIME + ($saldoAnteriorDestino == null ? 43 : $saldoAnteriorDestino.hashCode());
        final java.lang.Object $saldoPosteriorDestino = this.getSaldoPosteriorDestino();
        result = result * PRIME + ($saldoPosteriorDestino == null ? 43 : $saldoPosteriorDestino.hashCode());
        return result;
    }
    ...
    public java.lang.String toString() {
        return "TransacaoDTO(id=" + this.getId() + ", contaOrigemId=" + this.getContaOrigemId() + ", contaOrigemNumero=" + this.getContaOrigemNumero() + ", contaDestinoId=" + this.getContaDestinoId() + ", contaDestinoNumero=" + this.getContaDestinoNumero() + ", tipoTransacao=" + this.getTipoTransacao() + ", valor=" + this.getValor() + ", descricao=" + this.getDescricao() + ", status=" + this.getStatus() + ", codigoTransacao=" + this.getCodigoTransacao() + ", dadosPix=" + this.getDadosPix() + ", dadosTed=" + this.getDadosTed() + ", dataTransacao=" + this.getDataTransacao() + ", dataProcessamento=" + this.getDataProcessamento() + ", dataCriacao=" + this.getDataCriacao() + ", dataAtualizacao=" + this.getDataAtualizacao() + ", saldoAnteriorOrigem=" + this.getSaldoAnteriorOrigem() + ", saldoPosteriorOrigem=" + this.getSaldoPosteriorOrigem() + ", saldoAnteriorDestino=" + this.getSaldoAnteriorDestino() + ", saldoPosteriorDestino=" + this.getSaldoPosteriorDestino() + ")";
    }
    ...
    public static TransacaoDTO fromEntity(Transacao entity) {
        ...
        dto.setDadosPix(entity.getDadosPix());
        dto.setDadosTed(entity.getDadosTed());
        ...
        if (entity.getContaOrigem() != null) {
            ...
            dto.setContaOrigemNumero(entity.getContaOrigem().getNumeroConta());
        }
        if (entity.getContaDestino() != null) {
            dto.setContaDestinoNumero(entity.getContaDestino().getNumeroConta());
        }
        return dto;
    }
