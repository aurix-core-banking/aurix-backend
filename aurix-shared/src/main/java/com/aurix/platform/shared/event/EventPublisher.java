...
public class EventPublisher {
    ...
    /**
     * Publica evento em tópico arbitrário.
     * <p>
     * Usado pelo {@code EventHub} para roteamento dinâmico.
     * Subclasses (ex: {@code OutboxEventPublisher}) devem sobrescrever
     * este método para adicionar persistência em outbox.
     *
    ...
    /**
     * Publica evento genérico no Kafka.
     *
     * @param topic Tópico para publicação
     * @param event Evento a ser publicado
     */
    protected void publishEvent(final String topic, final BaseEvent event) {
        try {
