 ...
 * 
 * Gerencia todos os recebimentos financeiros do banco
 */
@Entity
@Table(name = "contas_receber", schema = "aurix")
public class ContaReceber {
    ...
    public enum StatusConta {
        PENDENTE,  // Pendente de recebimento
        RECEBIDA,  // Recebida
        VENCIDA,  // Vencida
        CANCELADA,  // Cancelada
        PARCELADA,  // Parcelada
    ...
    public static class ContaReceberBuilder {
        @java.lang.SuppressWarnings("all")
        private Long id;
        @java.lang.SuppressWarnings("all")
        private String numeroDocumento;
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder id(final Long id) {
            this.id = id;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder numeroDocumento(final String numeroDocumento) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder descricao(final String descricao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder clienteId(final Long clienteId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorOriginal(final BigDecimal valorOriginal) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorRecebido(final BigDecimal valorRecebido) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorJuros(final BigDecimal valorJuros) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorMulta(final BigDecimal valorMulta) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorDesconto(final BigDecimal valorDesconto) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder valorTotal(final BigDecimal valorTotal) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataVencimento(final LocalDate dataVencimento) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataRecebimento(final LocalDate dataRecebimento) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataEmissao(final LocalDate dataEmissao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder status(final StatusConta status) {
            this.status = status;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder tipoConta(final TipoConta tipoConta) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder categoria(final String categoria) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder centroCusto(final String centroCusto) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder observacoes(final String observacoes) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder anexos(final String anexos) {
            this.anexos = anexos;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder usuarioCriacao(final String usuarioCriacao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder usuarioAprovacao(final String usuarioAprovacao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataAprovacao(final LocalDateTime dataAprovacao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder moeda(final String moeda) {
            this.moeda = moeda;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder taxaCambio(final BigDecimal taxaCambio) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder metadata(final String metadata) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataCriacao(final LocalDateTime dataCriacao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder dataAtualizacao(final LocalDateTime dataAtualizacao) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ContaReceber.ContaReceberBuilder versao(final Long versao) {
            this.versao = versao;
            return this;
        }

        @java.lang.SuppressWarnings("all")
        public ContaReceber build() {
            return new ContaReceber(this.id, this.numeroDocumento, this.descricao, this.clienteId, this.valorOriginal, this.valorRecebido, this.valorJuros, this.valorMulta, this.valorDesconto, this.valorTotal, this.dataVencimento, this.dataRecebimento, this.dataEmissao, this.status, this.tipoConta, this.categoria, this.centroCusto, this.observacoes, this.anexos, this.usuarioCriacao, this.usuarioAprovacao, this.dataAprovacao, this.moeda, this.taxaCambio, this.metadata, this.dataCriacao, this.dataAtualizacao, this.versao);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
            return "ContaReceber.ContaReceberBuilder(id=" + this.id + ", numeroDocumento=" + this.numeroDocumento + ", descricao=" + this.descricao + ", clienteId=" + this.clienteId + ", valorOriginal=" + this.valorOriginal + ", valorRecebido=" + this.valorRecebido + ", valorJuros=" + this.valorJuros + ", valorMulta=" + this.valorMulta + ", valorDesconto=" + this.valorDesconto + ", valorTotal=" + this.valorTotal + ", dataVencimento=" + this.dataVencimento + ", dataRecebimento=" + this.dataRecebimento + ", dataEmissao=" + this.dataEmissao + ", status=" + this.status + ", tipoConta=" + this.tipoConta + ", categoria=" + this.categoria + ", centroCusto=" + this.centroCusto + ", observacoes=" + this.observacoes + ", anexos=" + this.anexos + ", usuarioCriacao=" + this.usuarioCriacao + ", usuarioAprovacao=" + this.usuarioAprovacao + ", dataAprovacao=" + this.dataAprovacao + ", moeda=" + this.moeda + ", taxaCambio=" + this.taxaCambio + ", metadata=" + this.metadata + ", dataCriacao=" + this.dataCriacao + ", dataAtualizacao=" + this.dataAtualizacao + ", versao=" + this.versao + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
    public static ContaReceber.ContaReceberBuilder builder() {
        return new ContaReceber.ContaReceberBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setValorRecebido(final BigDecimal valorRecebido) {
        this.valorRecebido = valorRecebido;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setDataRecebimento(final LocalDate dataRecebimento) {
        this.dataRecebimento = dataRecebimento;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ContaReceber other = (ContaReceber) o;
        ...
        final java.lang.Object this$valorRecebido = this.getValorRecebido();
        final java.lang.Object other$valorRecebido = other.getValorRecebido();
        if (this$valorRecebido == null ? other$valorRecebido != null : !this$valorRecebido.equals(other$valorRecebido)) return false;
        ...
        final java.lang.Object this$dataRecebimento = this.getDataRecebimento();
        final java.lang.Object other$dataRecebimento = other.getDataRecebimento();
        if (this$dataRecebimento == null ? other$dataRecebimento != null : !this$dataRecebimento.equals(other$dataRecebimento)) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ContaReceber;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $valorRecebido = this.getValorRecebido();
        result = result * PRIME + ($valorRecebido == null ? 43 : $valorRecebido.hashCode());
        ...
        final java.lang.Object $dataRecebimento = this.getDataRecebimento();
        result = result * PRIME + ($dataRecebimento == null ? 43 : $dataRecebimento.hashCode());
    ...
    @java.lang.SuppressWarnings("all")
    public ContaReceber(final Long id, final String numeroDocumento, final String descricao, final Long clienteId, final BigDecimal valorOriginal, final BigDecimal valorRecebido, final BigDecimal valorJuros, final BigDecimal valorMulta, final BigDecimal valorDesconto, final BigDecimal valorTotal, final LocalDate dataVencimento, final LocalDate dataRecebimento, final LocalDate dataEmissao, final StatusConta status, final TipoConta tipoConta, final String categoria, final String centroCusto, final String observacoes, final String anexos, final String usuarioCriacao, final String usuarioAprovacao, final LocalDateTime dataAprovacao, final String moeda, final BigDecimal taxaCambio, final String metadata, final LocalDateTime dataCriacao, final LocalDateTime dataAtualizacao, final Long versao) {
        this.id = id;
        this.numeroDocumento = numeroDocumento;
        this.descricao = descricao;
        this.clienteId = clienteId;
