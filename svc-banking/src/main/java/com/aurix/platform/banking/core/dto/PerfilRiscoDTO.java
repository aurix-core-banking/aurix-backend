...
public class PerfilRiscoDTO {
    ...
    private Integer tentativasLoginMaximas;
    private Integer tempoBloqueioMinutos;
    ...
    public static PerfilRiscoDTO fromEntity(PerfilRisco perfil) {
        PerfilRiscoDTO dto = new PerfilRiscoDTO();
        dto.setId(perfil.getId());
        dto.setCodigoPerfil(perfil.getCodigoPerfil());
        dto.setNomePerfil(perfil.getNomePerfil());
        dto.setDescricao(perfil.getDescricao());
        dto.setNivelRisco(perfil.getNivelRisco().name());
        dto.setValorLimiteDiario(perfil.getValorLimiteDiario());
        dto.setValorLimiteMensal(perfil.getValorLimiteMensal());
        dto.setValorLimiteAnual(perfil.getValorLimiteAnual());
        dto.setQuantidadeTransacoesDiarias(perfil.getQuantidadeTransacoesDiarias());
        dto.setQuantidadeTransacoesMensais(perfil.getQuantidadeTransacoesMensais());
        dto.setQuantidadeTransacoesAnuais(perfil.getQuantidadeTransacoesAnuais());
        dto.setPercentualLimiteCredito(perfil.getPercentualLimiteCredito());
        dto.setPercentualLimiteInvestimento(perfil.getPercentualLimiteInvestimento());
        dto.setRequerAprovacao(perfil.getRequerAprovacao());
        dto.setRequerDocumentacao(perfil.getRequerDocumentacao());
        dto.setRequerBiometria(perfil.getRequerBiometria());
        dto.setRequerToken(perfil.getRequerToken());
        dto.setRequerAssinaturaDigital(perfil.getRequerAssinaturaDigital());
        dto.setTempoSessaoMinutos(perfil.getTempoSessaoMinutos());
        dto.setTentativasLoginMaximas(perfil.getTentativasLoginMaximas());
        dto.setTempoBloqueioMinutos(perfil.getTempoBloqueioMinutos());
        dto.setAtivo(perfil.getAtivo());
        dto.setObservacoes(perfil.getObservacoes());
        dto.setRegrasEspeciais(perfil.getRegrasEspeciais());
        dto.setConfiguracoesAvancadas(perfil.getConfiguracoesAvancadas());
        dto.setDataInicioVigencia(perfil.getDataInicioVigencia());
        dto.setDataFimVigencia(perfil.getDataFimVigencia());
        dto.setUsuarioCriacao(perfil.getUsuarioCriacao());
        dto.setUsuarioAprovacao(perfil.getUsuarioAprovacao());
        dto.setDataAprovacao(perfil.getDataAprovacao());
        return dto;
    }

    public PerfilRisco toEntity() {
        PerfilRisco perfil = new PerfilRisco();
        perfil.setId(this.id);
        perfil.setCodigoPerfil(this.codigoPerfil);
        perfil.setNomePerfil(this.nomePerfil);
        perfil.setDescricao(this.descricao);
        perfil.setNivelRisco(PerfilRisco.NivelRisco.valueOf(this.nivelRisco));
        perfil.setValorLimiteDiario(this.valorLimiteDiario);
        perfil.setValorLimiteMensal(this.valorLimiteMensal);
        perfil.setValorLimiteAnual(this.valorLimiteAnual);
        perfil.setQuantidadeTransacoesDiarias(this.quantidadeTransacoesDiarias);
        perfil.setQuantidadeTransacoesMensais(this.quantidadeTransacoesMensais);
        perfil.setQuantidadeTransacoesAnuais(this.quantidadeTransacoesAnuais);
        perfil.setPercentualLimiteCredito(this.percentualLimiteCredito);
        perfil.setPercentualLimiteInvestimento(this.percentualLimiteInvestimento);
        perfil.setRequerAprovacao(this.requerAprovacao);
        perfil.setRequerDocumentacao(this.requerDocumentacao);
        perfil.setRequerBiometria(this.requerBiometria);
        perfil.setRequerToken(this.requerToken);
        perfil.setRequerAssinaturaDigital(this.requerAssinaturaDigital);
        perfil.setTempoSessaoMinutos(this.tempoSessaoMinutos);
        perfil.setTentativasLoginMaximas(this.tentativasLoginMaximas);
        perfil.setTempoBloqueioMinutos(this.tempoBloqueioMinutos);
        perfil.setAtivo(this.ativo);
        perfil.setObservacoes(this.observacoes);
        perfil.setRegrasEspeciais(this.regrasEspeciais);
        perfil.setConfiguracoesAvancadas(this.configuracoesAvancadas);
        perfil.setDataInicioVigencia(this.dataInicioVigencia);
        perfil.setDataFimVigencia(this.dataFimVigencia);
        perfil.setUsuarioCriacao(this.usuarioCriacao);
        perfil.setUsuarioAprovacao(this.usuarioAprovacao);
        perfil.setDataAprovacao(this.dataAprovacao);
        return perfil;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof PerfilRiscoDTO)) return false;
        final PerfilRiscoDTO other = (PerfilRiscoDTO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof PerfilRiscoDTO;
    }
