...
@java.lang.SuppressWarnings("all")
    ...
    public java.lang.String toString() {
        return "ParceiroAdquirente(id=" + this.getId() + ", nome=" + this.getNome() + ", tipoEndpoint=" + this.getTipoEndpoint() + ", config=" + this.getConfig() + ", ativo=" + this.getAtivo() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public ParceiroAdquirente() {
    }

    @java.lang.SuppressWarnings("all")
    public ParceiroAdquirente(final Long id, final String nome, final String tipoEndpoint, final String config, final Boolean ativo) {
        this.setId(id);
        this.nome = nome;
        this.tipoEndpoint = tipoEndpoint;
        this.config = config;
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ParceiroAdquirente)) return false;
        final ParceiroAdquirente other = (ParceiroAdquirente) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ParceiroAdquirente;
    }
